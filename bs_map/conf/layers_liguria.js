OPS_Map.MyAddLayers = function () {
    ...
    OPS_Map.addOSMLayer("Bianco", 'https://cartodb-basemaps-a.global.ssl.fastly.net/light_nolabels/{z}/{x}/{y}.png', true, false);
    ...
    OPS_Map.addWMSLayer("IGM 1:25000", "openkis_proxy.php/http://wms.pcn.minambiente.it/ogc?map=/ms_ogc/WMS_v1.3/raster/IGM_25000.map&", 'CB.IGM25000', false, false, "image/png", 'EPSG:4326');
    OPS_Map.addWMSLayer("IGM 1:25000 Liguria", "openkis_proxy.php/http://sgi2.isprambiente.it/arcgis/services/raster/igm25k_liguria_wgs/ImageServer/WMSServer", 'igm25k_liguria_wgs', false, false, "png", 'EPSG:4326');
    ...
    OPS_Map.addWMSLayer("Ortofoto 2019", "openkis_proxy.php/https://geoservizi.regione.liguria.it/geoserver/M2248/wms?", 'L8256', false, false, "image/png");
