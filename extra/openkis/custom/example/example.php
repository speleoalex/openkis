<?php
/*
 * Funzioni specifiche per il catasto speleologico di una regione
 * 
 */
...
$_FN['modparams']["caves"]['editorparams']['table']['function_on_insert']="GenCodeCave";
$_FN['modparams']["artificials"]['editorparams']['table']['function_on_insert']="GenCodeArtificials";
 ...
 * @param type $table
 */
function FirstNumberFree($table)
{
 ...
 * @return type
 */
function GenCodeArtificials($values)
{
    ...
    $numero=FirstNumberFree("ctl_artificials");
...
function GenCodeCave($values)
{
    ...
    //inizializza la variabile oggetto che punta alla tabella
    $numero=FirstNumberFree("ctl_caves");
