...
class xmetadbfrm_field_filecatasto
{
    ...
    function view($params)
    {
        ...
        $table=xmetadb_table($databasename,$tablename);
        $htmlout="";
        ...
        $htmlout.="\n<a title=\"Download $value\" href=\"?$link&xmetadb_ddfile_{$params['name']}={$values[$params['name']]}\"  >$value</a>";
        ...
        $paramsTable = array();
        $paramsTable['databasename']="$databasename"; 
        $stat=FN_XMDBTable($tablename."_download_stat",$paramsTable);
