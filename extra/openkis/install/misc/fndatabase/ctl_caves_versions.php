...
<tables>
    ...
    <field>
        ...
        <type>string</type>
        <frm_size>8</frm_size>
        <frm_help_it>Lasciare vuoto per auto assegnazione</frm_help_it>
        <unique></unique>
    </field>
    <field>
        <name>groupview</name>
    ...
    <field>
        ...
        <frm_group_it>Localizzazione ingresso</frm_group_it>
        <name>regione</name>
        <type>select</type>
    ...
    <field>
        ...
        <fk_link_field>code</fk_link_field>
        <fk_show_field>code,name</fk_show_field>
        <frm_group>Terreno geologico</frm_group>
    </field>
    <field>
    ...
    <field>
        ...
        <frm_group_it>Posizione ingresso</frm_group_it>
        <type>string</type>
    ...
    <field>
        ...
        <view_group>Posizione ingresso</view_group>
    ...
    <field>
        ...
        <foreignkey>ctl_DBCAVE</foreignkey>
        <fk_link_field>IDRO</fk_link_field>
        <fk_show_field>IDRO</fk_show_field>
    </field>
    <field>
        <name>trend</name>
    ...
    <field>
        ...
        <frm_type>multicheck</frm_type>
        <frm_options>blow_during_heat,blow_during_cold,suck_during_heat,suck_during_cold,blow_during_cold,none,blow_always,suck_always,none_in_heat,none_in_cold</frm_options>
    ...
    <innertable>
        ...
        <innertablefields>id,name,survey,filekml,date,author</innertablefields>
        <view></view>
    </innertable>
    <innertable>
