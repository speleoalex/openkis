...
FNCC_ManageEditRegister($_FN['user'], "index.php?fnapp=controlcenter&opt=$opt", "index.php?fnapp=controlcenter&opt=$opt", $tplform_file, $tplpage_file);
...
function FNCC_ManageEditRegister($user = "", $formaction = "", $urlcancel = "", $tplform_file = "", $tplpage_file = "")
{
    ...
    $opt = FN_GetParam("opt", $_GET);
    if (!$formaction)
        $formaction = FN_RewriteLink("index.php?fnapp=controlcenter&opt=$opt");
    if (!$urlcancel)
        $urlcancel = FN_RewriteLink("index.php?fnapp=controlcenter");
    if ($user == "")
    {
        $user = $_FN['user'];
    }
