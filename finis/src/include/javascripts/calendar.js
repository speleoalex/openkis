...
RenderCssCal = function (bNewCal)
{
    ...
    winCalData = "<span class='xmetadbcalendar' onmouseover='Calendar.focus=2' onmouseout='Calendar.focus=1' style='z-index:999;display:block;cursor:auto;position:absolute;top:" + top + "px;left:" + left + "px;border:1px solid " + SpanBorderColor + ";'>";
    //
    ...
    if (!winCal)
    {
        ...
        //splx
        cssStr = "span.xmetadbcalendar,span.xmetadbcalendar * {font-family: Arial;font-size: 12px;line-height: 14px;padding:1px;margin:0px;border:0px;text-align:center}\n";
        ...
        cssStr += ".xmetadbcalendar td{padding:3px;white-space:nowrap}";
        cssStr += ".xmetadbcalendar input,.xmetadbcalendar select{border:0px solid #080808;margin:1px;padding:5px;background-color:#ffffff;color:#000000}";
        cssStr += ".xmetadbcalendar input[type=button]{border:1px solid #080808;margin:1px;padding:5px;background-color:#dddddd;color:#000000}";
