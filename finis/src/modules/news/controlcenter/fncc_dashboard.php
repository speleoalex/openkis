...
if ( $unpublished > 0 )
	echo "<a href=\"controlcenter.php?fnapp=controlcenter&mod={$_FN['mod']}&op=edit&opt=fnc_ccnf_section_{$_FN['mod']}\">" . FN_i18n("unpublished news") . "</a> : $unpublished<br />";
else
	echo "" . FN_i18n("no unpublished news") . "<br />";
if ( $signed > 0 )
	echo "<a href=\"controlcenter.php?fnapp=controlcenter&mod={$_FN['mod']}&op=edit&signews=1&opt=fnc_ccnf_section_{$_FN['mod']}\">" . FN_i18n("signed news") . "</a> : $signed<br />";
else
...
{
    echo "<div>";
    $urlnew = "?fnapp=controlcenter&desc___xdb_{$_FN['mod']}=1&op___xdb_{$_FN['mod']}=insnew&opt=fnc_ccnf_section_{$_FN['mod']}&mod={$_FN['mod']}";
